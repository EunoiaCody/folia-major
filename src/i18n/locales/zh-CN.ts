...
export default {
  "notifications": {
    ...
    "unlockVipSongsOn": "VIP 歌曲解锁已开启",
    "unlockVipSongsOff": "VIP 歌曲解锁已关闭",
    "unlockCrossFallbackOn": "跨平台歌曲音源替换已开启",
    "unlockCrossFallbackOff": "跨平台歌曲音源替换已关闭",
    "unlockUnavailableSongsOn": "无版权歌曲自动替代已开启",
    "unlockUnavailableSongsOff": "无版权歌曲自动替代已关闭",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "unlock-vip-songs-toggle": { "title": "VIP 歌曲解锁", "description": "开关 VIP 网易云歌曲的完整播放解锁" },
      "unlock-cross-provider-fallback-toggle": { "title": "跨平台歌曲音源替换", "description": "解锁失败时在酷狗/QQ 搜索同一首歌" },
      "unlock-unavailable-songs-toggle": { "title": "无版权歌曲自动替代", "description": "无版权网易云歌曲用其他平台同曲音源播放" },
  ...
  "home": {
    ...
    "loginSuccess": "登录成功！",
    "loginError": "登录错误",
    "phoneLoginQrTab": "扫码登录",
    "phoneLoginSwitch": "手机号登录",
    "phoneLoginDesc": "短信验证码由网易云音乐官方发送，验证码有效期为 5 分钟",
    "phoneNumber": "手机号",
    "captchaCode": "短信验证码",
    "sendCaptcha": "发送验证码",
    "sendCaptchaCountdown": "{{seconds}} 秒后重发",
    "phoneLogin": "登录",
    "phoneLoggingIn": "登录中...",
    "phoneInvalid": "请输入正确的 11 位手机号",
    "captchaInvalid": "请输入短信验证码",
    "captchaSendFailed": "验证码发送失败，请稍后再试",
    "phoneLoginFailed": "登录失败，请检查手机号与验证码",
    "cookieLoginSwitch": "Cookie 登录",
    "cookieLoginDesc": "在浏览器登录 music.163.com 后，按 F12 → 网络/应用 → 复制 Cookie 粘贴到此处。Cookie 仅保存在本机。",
    "cookieLoginValue": "网易云登录 Cookie",
    "cookieLoginPlaceholder": "MUSIC_U=...; __csrf=...",
    "cookieLogin": "登录",
    "cookieLoggingIn": "登录中...",
    "cookieEmpty": "请粘贴网易云登录 Cookie",
    "cookieLoginFailed": "登录失败，Cookie 可能已过期或无效",
    "retryQr": "刷新二维码",
    "closeLogin": "关闭登录窗口",
    "logout": "退出登录",
    "backToPlayer": "返回播放器",
  ...
  "options": {
    ...
    "unlockVipSongsSection": "VIP 歌曲解锁",
    "unlockVipSongs": "解锁 VIP 歌曲",
    "unlockVipSongsDesc": "网易云仅提供试听时播放完整曲目：先使用同平台完整音源，失败后回退到酷狗/QQ 的同曲音源。",
    "unlockUseCrossProviderFallback": "跨平台歌曲音源替换",
    "unlockUseCrossProviderFallbackDesc": "同平台解锁不可用时，依次在酷狗、QQ 搜索同一首歌并使用其音源播放。",
    "unlockUnavailableSongs": "无版权歌曲自动替代",
    "unlockUnavailableSongsDesc": "网易云标记无版权（灰色）的歌曲，播放时自动在其他平台匹配同曲音源。",
    "lyricMatchPriority": "歌词匹配优先级",
