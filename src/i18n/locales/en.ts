...
export default {
  "notifications": {
    ...
    "unlockVipSongsOn": "VIP song unlock enabled",
    "unlockVipSongsOff": "VIP song unlock disabled",
    "unlockCrossFallbackOn": "Cross-provider song fallback enabled",
    "unlockCrossFallbackOff": "Cross-provider song fallback disabled",
    "unlockUnavailableSongsOn": "Unavailable-song auto-replace enabled",
    "unlockUnavailableSongsOff": "Unavailable-song auto-replace disabled",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "unlock-vip-songs-toggle": { "title": "VIP song unlock", "description": "Toggle full-length playback for VIP NetEase songs" },
      "unlock-cross-provider-fallback-toggle": { "title": "Cross-provider song fallback", "description": "Search Kugou/QQ for the same song when unlock fails" },
      "unlock-unavailable-songs-toggle": { "title": "Unavailable-song auto-replace", "description": "Play grey NetEase songs via matched sources from other platforms" },
  ...
  "home": {
    ...
    "phoneLoginQrTab": "QR Code",
    "phoneLoginSwitch": "Phone number",
    "phoneLoginDesc": "The SMS code is sent by NetEase Cloud Music and valid for 5 minutes",
    "phoneNumber": "Phone number",
    "captchaCode": "SMS code",
    "sendCaptcha": "Send code",
    "sendCaptchaCountdown": "Resend in {{seconds}}s",
    "phoneLogin": "Log in",
    "phoneLoggingIn": "Logging in...",
    "phoneInvalid": "Enter a valid 11-digit phone number",
    "captchaInvalid": "Enter the SMS code",
    "captchaSendFailed": "Failed to send the code. Try again later.",
    "phoneLoginFailed": "Login failed. Check the phone number and code.",
    "cookieLoginSwitch": "Cookie",
    "cookieLoginDesc": "Log in to music.163.com in a browser, press F12, copy the Cookie and paste it here. The cookie is stored on this device only.",
    "cookieLoginValue": "NetEase login cookie",
    "cookieLoginPlaceholder": "MUSIC_U=...; __csrf=...",
    "cookieLogin": "Log in",
    "cookieLoggingIn": "Logging in...",
    "cookieEmpty": "Paste the NetEase login cookie",
    "cookieLoginFailed": "Login failed. The cookie may be expired or invalid.",
  ...
  "options": {
    ...
    "unlockVipSongsSection": "VIP Song Unlock",
    "unlockVipSongs": "Unlock VIP Songs",
    "unlockVipSongsDesc": "Play the full track when NetEase grants only a trial: first use the same-platform full source, then fall back to a matched source from Kugou/QQ.",
    "unlockUseCrossProviderFallback": "Cross-provider song fallback",
    "unlockUseCrossProviderFallbackDesc": "When same-platform unlock is unavailable, search Kugou then QQ for the same song and use its audio source.",
    "unlockUnavailableSongs": "Unavailable-song auto-replace",
    "unlockUnavailableSongsDesc": "Play NetEase songs marked unavailable (grey) by matching the same track on other platforms.",
    "lyricMatchPriority": "Lyric match priority",
    "lyricMatchPriorityDesc": "When multiple lyric sources have high-confidence matches, prefer this source first.",
