...
export default {
  "notifications": {
    ...
    "unlockVipSongsOn": "Buka kunci lagu VIP diaktifkan",
    "unlockVipSongsOff": "Buka kunci lagu VIP dimatikan",
    "unlockCrossFallbackOn": "Penggantian sumber lintas platform diaktifkan",
    "unlockCrossFallbackOff": "Penggantian sumber lintas platform dimatikan",
    "unlockUnavailableSongsOn": "Penggantian otomatis lagu tak berlisensi diaktifkan",
    "unlockUnavailableSongsOff": "Penggantian otomatis lagu tak berlisensi dimatikan",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "unlock-vip-songs-toggle": { "title": "Buka kunci lagu VIP", "description": "Alihkan pemutaran penuh untuk lagu VIP NetEase" },
      "unlock-cross-provider-fallback-toggle": { "title": "Penggantian sumber lintas platform", "description": "Cari lagu yang sama di Kugou/QQ saat buka kunci gagal" },
      "unlock-unavailable-songs-toggle": { "title": "Penggantian otomatis lagu tak berlisensi", "description": "Putar lagu NetEase abu-abu via sumber dari platform lain" },
  ...
  "home": {
    ...
    "phoneLoginQrTab": "Kode QR",
    "phoneLoginSwitch": "Nomor ponsel",
    "phoneLoginDesc": "Kode SMS dikirim oleh NetEase Cloud Music dan berlaku 5 menit",
    "phoneNumber": "Nomor ponsel",
    "captchaCode": "Kode SMS",
    "sendCaptcha": "Kirim kode",
    "sendCaptchaCountdown": "Kirim ulang dalam {{seconds}}d",
    "phoneLogin": "Masuk",
    "phoneLoggingIn": "Masuk...",
    "phoneInvalid": "Masukkan nomor ponsel 11 digit yang valid",
    "captchaInvalid": "Masukkan kode SMS",
    "captchaSendFailed": "Gagal mengirim kode. Coba lagi nanti.",
    "phoneLoginFailed": "Masuk gagal. Periksa nomor ponsel dan kode.",
    "cookieLoginSwitch": "Cookie",
    "cookieLoginDesc": "Masuk ke music.163.com di peramban, tekan F12, salin Cookie dan tempel di sini. Cookie hanya disimpan di perangkat ini.",
    "cookieLoginValue": "Cookie login NetEase",
    "cookieLoginPlaceholder": "MUSIC_U=...; __csrf=...",
    "cookieLogin": "Masuk",
    "cookieLoggingIn": "Masuk...",
    "cookieEmpty": "Tempel cookie login NetEase",
    "cookieLoginFailed": "Masuk gagal. Cookie mungkin kedaluwarsa atau tidak valid.",
  ...
  "options": {
    ...
    "unlockVipSongsSection": "Buka Kunci Lagu VIP",
    "unlockVipSongs": "Buka Kunci Lagu VIP",
    "unlockVipSongsDesc": "Putar lagu penuh saat NetEase hanya memberi cuplikan: gunakan sumber lengkap platform yang sama dulu, lalu sumber yang cocok dari Kugou/QQ.",
    "unlockUseCrossProviderFallback": "Penggantian sumber lintas platform",
    "unlockUseCrossProviderFallbackDesc": "Saat buka kunci platform sama tidak tersedia, cari lagu yang sama di Kugou lalu QQ dan gunakan sumber audionya.",
    "unlockUnavailableSongs": "Penggantian otomatis lagu tak berlisensi",
    "unlockUnavailableSongsDesc": "Putar lagu NetEase yang ditandai tak berlisensi (abu-abu) dengan mencocokkan lagu yang sama di platform lain.",
    "lyricMatchPriority": "Prioritas pencocokan lirik",
    "lyricMatchPriorityDesc": "Saat beberapa sumber lirik memiliki kecocokan berkualitas tinggi, utamakan sumber ini terlebih dahulu.",
