...
import { Images, Layers3, Settings2 } from 'lucide-react';
...
export const settingsCommands: CommandPaletteCommand[] = [
    ...
    createToggleCommand(
        ...
        ['cross provider', 'song fallback', 'kuwo fallback', '酷狗替换', 'QQ替换', '跨平台替换', '跨源替换', 'kuaPingTai', 'kptyh', 'kpty'],
    ...
    createToggleCommand(
        ...
        ['unavailable replace', 'grey song', 'auto replace', '无版权替代', '无版权播放', '下架歌曲', '灰色歌曲', 'wbqth', 'wbqb'],
