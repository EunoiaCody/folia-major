...
export const buildSettingsCommandContext = (
    ...
    return {
        ...
        // 网易云解锁三开关：状态宿主在 useAudioSettingsStore，命令只做翻转。
        unlockVipSongs: audio.unlockVipSongs,
        toggleUnlockVipSongs: () => useAudioSettingsStore.getState().handleToggleUnlockVipSongs(
            !useAudioSettingsStore.getState().unlockVipSongs,
        ),
        unlockUnavailableSongs: audio.unlockUnavailableSongs,
        toggleUnlockUnavailableSongs: () => useAudioSettingsStore.getState().handleToggleUnlockUnavailableSongs(
            !useAudioSettingsStore.getState().unlockUnavailableSongs,
        ),
        unlockUseCrossProviderFallback: audio.unlockUseCrossProviderFallback,
        toggleUnlockUseCrossProviderFallback: () => useAudioSettingsStore.getState().handleToggleUnlockUseCrossProviderFallback(
            !useAudioSettingsStore.getState().unlockUseCrossProviderFallback,
        ),
